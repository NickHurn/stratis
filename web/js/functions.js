...
function HideAnimate(element) 
{
	...
	element.style.clip="rect(0px 520px "+(c_step*AnimationStep)+"px 0px)";
...
function fill_dropdown(text,type,selected_value,selected_location)
{
	...
	if(splitArray.length>1)
	{
		...
		{
			document.getElementById("label_"+type).innerHTML="<a href=\"javascript:cancelDropDown('"+type+"')\">"+selected_value+"</a> > ";
		}
	}	
