...
class NumberRangeFieldParams extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('min', NumberType::class, ['required'=>true]);
        $builder->add('max', NumberType::class, ['required'=>true]);
        ...
        $builder->add('submit', SubmitType::class, ['label' => 'Add Number Range Input', 'attr' => ['class' => 'btn btn-black btn-lrg']]);
    }
