 ...
 * FormQuestions
 *
 * @ORM\Table(name="pool_questions")
 * @ORM\Entity(repositoryClass="AppBundle\Entity\PoolQuestionsRepository")
 */
class PoolQuestions
{
	/**
     ...
     * @var integer
     *
     * @ORM\Column(name="pool_id", type="integer", nullable=false)
     */
    private $poolId;
     ...
     * @return FormQuestions
     */
    public function setPoolQuestions($number)
    {
        return $this;
    }
