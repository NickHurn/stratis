CREATE DATABASE  IF NOT EXISTS `hireabl` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `hireabl`;
-- MySQL dump 10.13  Distrib 8.0.25, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: hireabl
-- ------------------------------------------------------
...
CREATE TABLE `aml_data` (
  ...
  `authenticity` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `data_sent` longtext COLLATE utf8_unicode_ci,
  `testinfo` longtext COLLATE utf8_unicode_ci,
...
CREATE TABLE `choice_field` (
  ...
  `field_type` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `classmarker_group_results` (
  ...
  `requires_grading` varchar(3) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`pk_id`),
...
CREATE TABLE `classmarker_link_results` (
  ...
  `requires_grading` varchar(3) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cm_user_id` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `access_code` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `extra_info` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `extra_info2` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `extra_info3` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `extra_info4` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `extra_info5` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `classmarker_links` (
  ...
  `link_url` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `css_schemes` VALUES (1,1,'khireabl.erigan.co.uk','Hireabl','#d91919','','','#d91919','Hireabl Ltd','','#d91919','#d91919','','0800 123 1234','info@hireabl.com');
...
INSERT INTO `cv_check` VALUES (8,1,'0000-00-00 00:00:00');
...
CREATE TABLE `dashboard_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `overview_config` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `detail_config` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `devphone` (
  ...
  `msg` varchar(2185) COLLATE utf8_unicode_ci NOT NULL,
  `rand` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `employers` VALUES (1,'Hireabl',NULL,'123',NULL);
...
CREATE TABLE `extrachecks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `employer_id` int(11) DEFAULT NULL,
  `job_code` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `check_type` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `form_answers` (
  ...
  `question_type` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `forms` (
  ...
  `form_type` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `employer_id` int(11) DEFAULT NULL,
  `job_id` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `history_employment` (
  ...
  `created_on` datetime DEFAULT NULL,
  `employment_status` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `history_employment` VALUES (1,2,'0220cea7a1301c1e8f3f2ada78412736','Koine',1,'Fucked','2011-06-01 00:00:00','2021-06-01 00:00:00','wankers','2021-06-29 20:31:53','unemployed');
...
INSERT INTO `interviews` VALUES (1,2,'0220cea7a1301c1e8f3f2ada78412736',1,1,'2021-06-30 01:30:00',1,1,'2021-06-29 21:42:43',0,NULL,1,'2021-07-07 12:51:44','',NULL,NULL,'aa4e8c65369cfbe949c078f899791262','twat',NULL);
...
CREATE TABLE `jobs` (
  ...
  `title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `standfirst` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `form_token` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `media` (
  ...
  `filename` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `extn` longtext COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `passport_data` (
  ...
  `mrz` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `document_number` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `country` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `authenticity` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `testinfo` longtext COLLATE utf8_unicode_ci,
...
CREATE TABLE `pools` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pool_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `employer_id` int(11) DEFAULT NULL,
  `num_questions` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `users` VALUES (1,'admin','$2y$13$q3FDfCaLveYQq2oBQ.2oDu9vZRQgfM61A/aw0nAlQcrJlrdo.nxOe','Matt','David','+99 8111 2222','+99 07123 123456','admin@dev.dev',NULL,1,'RfNZL6Xcaw17QKYijcBaZuRWLbpJFnG7RXSrG+9Nsh5wiHX1I4r09Y1FpzL1SsEzmtUxEIXtVObI3ZvrQdizrg==','2021-07-13 02:04:03',NULL,0,'',0),(2,NULL,'$2y$13$nOOYtUR7iJSev/oeCCclmOLzYgyvGxdpNG1Zt99v5yfFDEfHTKSHy','matt','dangerfield','02034343949','07966265939','matt.dangerfield@fintech-advisers.com',NULL,NULL,'ngO+V9FNziWhtHP97keS9Y7c+s9cu/HXPre8X6Hyzz2F63upyFIDJ5EBfC3dyD2M69i+5TGJxKHaqizycNI0WA==','2021-07-07 17:50:50',NULL,0,'',0);
...
CREATE TABLE `video_questions` (
  ...
  `video_id` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2021-09-22 21:02:31
